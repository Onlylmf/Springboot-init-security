package com.murphy.config.filter;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private String getTokenFromHttpRequest(HttpServletRequest request) {
        String authorization = request.getHeader(ConfigConstant.TOKEN_HEADER);
        if (authorization == null || !authorization.startsWith(ConfigConstant.TOKEN_PREFIX)) {
            return null;
        }
        // 去掉 token 前缀
        return authorization.replace(ConfigConstant.TOKEN_PREFIX, "");
    }
